            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="tasks.html"><i class="fa fa-table fa-fw"></i> Tasks</a>
                        </li>
                        <!-- /.navbar-static-side -->
        </nav>
                            ...
                            <div class="row">
                                <div>
									...
									<div class="form-group">
                                            <label>ID</label>
                                            <input type="text" value='<?php echo $idtag; ?>' class="field left" readonly name="id">
                                            <p class="help-block">This is your Task ID</p>
                                        </div>
