        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                 ...
                 <div style="display: inline" ><div align="right"><form method="get" action="forms.php"><button type="submit" class="btn btn-success">Create New Task</button></form> </div></div>
                        </div>
